...
This API may be accessed by administrators through an active web session within the application or 
through authorizing a client application through OAuth. All examples assume OAuth2 bearer token; e.g.
